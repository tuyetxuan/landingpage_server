...
import {getAllArticleCategories, getAllArticleCategoriesForAdmin} from "#services/ArticleCategoryService.js";
...
const __articleCategory__ = {
	...
	getAllArticleCategoriesForAdmin: async (req, res, next) => {
		const __ = await getAllArticleCategoriesForAdmin(req);
		if (__ instanceof SUCCESS_RESPONSE)
			return __.send(res);
		else
			new __RESPONSE__.FETCHED({
